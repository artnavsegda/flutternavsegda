...
class TextCharacteristic extends StatelessWidget {
  ...
  final GraphCharacteristic? element;

  @override
  Widget build(BuildContext context) {
    if (element!.type == CharacteristicType.text)
...
class _CharacteristicsElementState extends State<CharacteristicsElement> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        if (widget.element!.type == CharacteristicType.volume ||
            widget.element!.type == CharacteristicType.size)
          Row(children: [
